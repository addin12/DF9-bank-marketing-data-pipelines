...
dataset_url = f"https://drive.google.com/uc?export=download&id=1Fab7jePW3LKFUNyJf2BoH6ywrDiXatNt"
# path_to_local_home = os.environ.get("AIRFLOW_HOME", "/opt/airflow/")
path_to_local_home = "/opt/airflow"
parquet_file = dataset_file.replace('.csv', '.parquet')
BIGQUERY_DATASET = os.environ.get("BIGQUERY_DATASET", 'bank_marketing_dwh')
dbt_loc = os.environ.get("DBT_PROFILES_DIR")
